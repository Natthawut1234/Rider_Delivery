...
class BaseAPI_URL {
  ...
  // URL ตัวเลือกต่างๆ
  static const String localhostURL = 'http://10.5.50.45:4000/rider';
  static const String androidEmulatorURL = 'http://10.5.50.45:4000/rider';
  // แทนที่ด้วย IP จริงของเครื่อง
  static const String localNetworkURL = 'http://10.5.50.45:4000/rider';
  //Socket URL
  static const String SocketURL = 'http://10.5.50.45:4000/riders/socket';

  static const String HostSocketURL = 'http://10.5.50.45:4000';
}
